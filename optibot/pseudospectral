...
def coll_points(N, scheme, precission = 20):
    ...
    if scheme == 'LG':
        ...
        raise ValueError(f'Unsupported scheme {scheme}, valid schemes are: LG, LGR, LGR_inv, LGL, LGLm, LG2, D2')
...
def base_points(N, scheme, precission = 20):
    ...
    if scheme == 'LG':
        ...
        raise ValueError(f'Unsupported scheme {scheme}, valid schemes are: LG, LG_inv LGR, LGR_inv, LGL, LGLm, LG2, D2')
